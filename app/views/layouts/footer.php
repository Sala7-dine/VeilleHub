<footer class="bg-cyan-100 text-white py-12 px-4 font-sans tracking-wide">
      <div class="text-center">
        <h6 class="text-lg text-gray-900">Stay connected with us:</h6>
        ...
        <p class="text-base text-gray-900">© Youdemy. All rights reserved.</p>
      </div>
    </footer>