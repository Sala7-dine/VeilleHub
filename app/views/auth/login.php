            ...
            <form class="mt-8 space-y-4" method="post" autocomplete="off">
              ...
              <div class="flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 shrink-0 text-cyan-600 focus:ring-cyan-500 border-gray-300 rounded" />
              ...
              <div class="!mt-8">
                <button type="submit" name="submit" id="submit" class="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none">
                  Sign in
                </button>
              </div>
              <p class="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <a href="/register" class="text-cyan-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
